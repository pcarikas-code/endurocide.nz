...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: "Effective infection prevention is built upon a multi-layered strategy, where each component reinforces the others. While terminal cleaning and routine disinfection of high-touch surfaces are fundamental, the patient environment is in a constant state of flux. Privacy curtains, due to their frequent contact by patients, visitors, and staff, can quickly become re-contaminated, undermining even the most diligent cleaning protocols.\n\nThis is where <strong>endurocide®</strong> antimicrobial curtains provide a crucial, persistent layer of defence. They act as a continuous, passive intervention, working 24/7 to kill pathogens that are deposited on their surface. This technology does not replace the need for hand hygiene or standard environmental cleaning; rather, it complements these efforts by ensuring that a major high-touch surface is self-sanitizing. By integrating <strong>endurocide®</strong> curtains, infection control professionals can close a significant loophole in their environmental hygiene protocols, adding a resilient and evidence-based layer to their facility’s defences against HAIs.",
